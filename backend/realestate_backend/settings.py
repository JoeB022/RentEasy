...
SECRET_KEY = 'django-insecure-&xvclvs%rl*j52tawyk8^=nt56&j61u84)k_bj-_r-z@zipep8'
...
# ✅ CORS settings
CORS_ALLOW_ALL_ORIGINS = True  # Use CORS_ALLOWED_ORIGINS in production for whitelisting
